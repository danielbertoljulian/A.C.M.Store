  ...
  return (
    <section id="contato" className="section-padding">
      <div className="container" style={{
        ...
        <div className="glass" style={{ padding: mobile ? '1.5rem' : '3rem', borderRadius: '12px', background: '#15181C', border: '1px solid #2A2D33' }}>
          {mobile ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem' }}>
              <p style={{ color: '#A7A7A0', textAlign: 'center' }}>
            ...
            <form onSubmit={(e) => {
              ...
              const texto = `Ola! Vim pelo site A.C.M Store.%0A%0A*Nome:* ${nome}%0A*E-mail:* ${email}%0A*Assunto:* ${assunto}%0A*Mensagem:* ${mensagem}`;
              window.open(`https://wa.me/5551997319858?text=${texto}`, '_blank');
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                ...
                <input name="email" type="email" placeholder="Seu E-mail" required style={{
                  background: '#15181C',
                  border: '1px solid #2A2D33',
                  padding: '1rem',
                  color: '#F5F5F0',
              ...
              <input name="assunto" type="text" placeholder="Assunto" required style={{
                background: '#15181C',
                border: '1px solid #2A2D33',
                padding: '1rem',
                color: '#F5F5F0',
              ...
              <textarea name="mensagem" placeholder="Como podemos ajudar?" rows="5" required style={{
                background: '#15181C',
                border: '1px solid #2A2D33',
                padding: '1rem',
                color: '#F5F5F0',
              ...
              <button type="submit" className="btn-premium" style={{ width: '100%' }}>Enviar Mensagem</button>
            </form>
          )}
        </div>
      </div>
