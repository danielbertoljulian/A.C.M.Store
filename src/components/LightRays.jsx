...
float rayStrength(vec2 raySource, vec2 rayRefDirection, vec2 coord,
  ...
  float baseStrength = clamp(
    (0.55 + 0.2 * sin(distortedAngle * seedA + iTime * speed)) +
    (0.4 + 0.25 * cos(-distortedAngle * seedB + iTime * speed)),
    0.0, 1.0
  );
...
void main() {
  ...
  return <div ref={containerRef} className={`light-rays-container ${className}`} style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none' }} />;
};
