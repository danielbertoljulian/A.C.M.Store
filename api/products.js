...
export async function POST(req) {
  ...
  try {
    ...
    await db`INSERT INTO products (id, name, slug, brand, categories, image, images, width, height, depth, colors, price, off, sort_order)
...
export async function PUT(req) {
  ...
  try {
    ...
    const updated = await db`UPDATE products SET
      ...
      colors = ${body.colors || ''}, price = ${body.price || ''}, off = ${body.off || ''}, sort_order = ${sortOrder}, updated_at = NOW()
